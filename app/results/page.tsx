                                    ...
                                    {seasonCards.length === 0 ? (
                                        ...
                                        seasonCards.map((card) => (
                                            <Link
                                                ...
                                                className="rounded-2xl border border-white/10 bg-zinc-950/40 p-5 hover:bg-white/10 transition"
                                            >
                                                <div className="text-xs tracking-widest text-zinc-400">{card.label}</div>
                                                <div className="mt-2 text-lg font-semibold text-white">
                                                    {card.seasonName}
                                                </div>
                                                <div className="mt-1 text-sm text-zinc-300">{card.leader}</div>
                                                <div className="mt-3 text-xs text-zinc-400">Races: {card.count}</div>
                                            </Link>
                                        ))
                                    )}
                                </div>
