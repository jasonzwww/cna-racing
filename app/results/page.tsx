                ...
                <div className="mt-10 space-y-10">
                    {seriesResults.map(({ series, seasons, order }) => {
                        ...
                        const seasonCards = seasonOrder.map((seasonName, idx) => {
                            ...
                            const cover = races.find((race) => race.entry.cover)?.entry.cover ?? null;
                                    ...
                                    {seasonCards.length === 0 ? (
                                        ...
                                        seasonCards.map((card) => (
                                            <Link
                                                ...
                                                className="group overflow-hidden rounded-2xl border border-white/10 bg-zinc-950/40 hover:bg-white/10 transition"
                                            >
                                                <div className="relative h-40 w-full overflow-hidden">
                                                    ...
                                                    <div className="absolute bottom-4 left-4 text-xs tracking-widest text-zinc-200">
                                                        {card.label}
                                                    </div>
                                                </div>
                                                <div className="p-5">
