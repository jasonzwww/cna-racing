    ...
    races: [
        {
            ...
            start: "2025-12-20T23:59:00-05:00",
        ...
        },
        {
            ...
            start: "2025-12-27T23:59:00-05:00",
            format: "P(60分钟) + Q(20分钟) + R(40分钟,强制1停)",
        },
        {
            round: 3,
            track: "Circuit des 24 Heures du Mans 勒芒",
            start: "2026-01-03T23:59:00-05:00",
            format: "P(60分钟) + Q(20分钟) + R(40分钟,强制1停)",
        },
        {
            round: 4,
            track: "Circuit de Spa-Francorchamps 斯帕",
            start: "2026-01-10T23:59:00-05:00",
            format: "P(60分钟) + Q(20分钟) + R(40分钟,强制1停)",
        },
        {
            round: 5,
