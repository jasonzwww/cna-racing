...
export const rookie = {
    ...
    races: [
        ...
        },
        {
            ...
            start: "2026-01-16T23:00:00Z",
            format: "MX-5 Cup · P(20min) + Q(20min) + R(20min)",
        },
        {
            round: 5,
            track: "Circuit de Lédenon 勒德农",
            start: "2026-01-23T23:00:00Z",
            format: "MX-5 Cup · P(20min) + Q(20min) + R(20min)",
        },
        {
            round: 6,
            track: "Oulton Park Circuit 奥尔顿公园",
            start: "2026-01-30T23:00:00Z",
            format: "MX-5 Cup · P(20min) + Q(20min) + R(20min)",
        },
        {
            round: 7,
            track: "Charlotte Motor Speedway 夏洛特",
            start: "2026-02-06T23:00:00Z",
            format: "MX-5 Cup · P(20min) + Q(20min) + R(20min)",
        },
        {
            round: 8,
        ...
        },
        {
            ...
            start: "2026-02-20T23:00:00Z",
            format: "MX-5 Cup · P(20min) + Q(20min) + R(20min)",
        },
        {
            round: 10,
            track: "Summit Point Raceway 萨米特角",
            start: "2026-02-27T23:00:00Z",
            format: "MX-5 Cup · P(20min) + Q(20min) + R(20min)",
            note: "收官战",
        },
